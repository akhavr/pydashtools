...
def encode_privkey(priv, formt, vbyte=76):
...
def privkey_to_address(priv, magicbyte=76):
...
def hex_to_b58check(inp, magicbyte=76):
...
def pubkey_to_address(pubkey, magicbyte=76):
